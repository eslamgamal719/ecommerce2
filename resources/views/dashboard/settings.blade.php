        ...
        <div class="box-body">
            ...
            <div class="form-group">
                ...
                @if(!empty(setting()->logo))
                    <img src="{{ Storage::url(setting()->logo) }}" class="img-thumbnail" style="width: 100px; height: 100px;">
                @endif
            </div>
            ...
            <div class="form-group">
                ...
                @if(!empty(setting()->icon))
                    <img src="{{ Storage::url(setting()->icon) }}" class="img-thumbnail" style="width: 100px; height: 100px;">
                @endif
            </div>
