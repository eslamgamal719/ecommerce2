    ...
    <div class="box">
        ...
        <div class="box-body">
            ...
            <div class="form-group">  <!-- getting it automatically like lat and lng if key is activated -->
                ...
                {!! Form::text('address', $manufacturer->address, ['class' => 'form-control address', 'id'=>"address"]) !!}
            </div>
            ...
            <div class="form-group">
                ...
                {!! Form::text('website', $manufacturer->website, ['class' => 'form-control']) !!}
            </div>
            ...
            <div class="form-group">
                ...
                @if(!empty($manufacturer->icon))
                    <img src="{{ Storage::url($manufacturer->icon) }}" class="img-thumbnail" style="width: 100px; height: 100px;">
                @endif
            </div>
