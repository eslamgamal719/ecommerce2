...
class SizeDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'dashboard.sizes.btn.checkbox')
            ->addColumn('edit', 'dashboard.sizes.btn.edit')
            ->addColumn('is_public', 'dashboard.sizes.btn.is_public')
            ->addColumn('delete', 'dashboard.sizes.btn.delete')
             ->rawColumns([
                 'edit',
                 'delete',
                 'checkbox',
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name' => 'department_id.dep_name_' . lang(),
