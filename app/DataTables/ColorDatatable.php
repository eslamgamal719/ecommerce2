...
class ColorDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'dashboard.colors.btn.checkbox')
            ->addColumn('edit', 'dashboard.colors.btn.edit')
            ->addColumn('color', 'dashboard.colors.btn.color')
            ->addColumn('delete', 'dashboard.colors.btn.delete')
             ->rawColumns([
                 'edit',
                 'color',
                 'delete',
