...
class ManufacturerDatatable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ->eloquent($query)
            ->addColumn('checkbox', 'dashboard.manufacturers.btn.checkbox')
            ->addColumn('edit', 'dashboard.manufacturers.btn.edit')
            ->addColumn('delete', 'dashboard.manufacturers.btn.delete')
             ->rawColumns([
                 'edit',
                 'delete',
                 'checkbox',
    ...
    {
        return 'manufacturers' . date('YmdHis');
    }
}
